...
launcher = 'none'
load_from = './projects/Distillation/checkpoints/best_coco_bbox_mAP_epoch_7.pth'
log_level = 'INFO'
...
model = dict(
    backbone=dict(
        ...
        type='FusionResNet',
        weight_path=
        'D:/Senior/lab/mmdetection/projects/BAANet/checkpoints/resnet50.pth'),
    ...
    './projects/BAANet/checkpoints/best_coco_bbox_mAP_epoch_9.pth',
    distilled_file_config=
    './projects/Distillation/configs/Distill_r50_fpn_1x_kaist.py',
    ...
    train_cfg=dict(
        ...
        rpn_proposal=dict(
            ...
            nms=dict(iou_threshold=0.7, type='nms'),
            nms_pre=2000)),
    type='MultiSpecDistillFasterRCNN')
optim_wrapper = dict(
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        'D:/Senior/lab/KAIST/kaist_test_anno/anno/test_anno/KAIST_test_RGB_annotation.json',
        backend_args=None,
        pipeline=[
