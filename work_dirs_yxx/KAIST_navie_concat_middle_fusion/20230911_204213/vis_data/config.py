...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        'D:/大四/实验室/KAIST/kaist_test_anno/anno/test_anno/KAIST_test_RGB_annotation.json',
        backend_args=None,
        pipeline=[
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        'D:/大四/实验室/KAIST/kaist_test_anno/anno/train_anno/KAIST_train_RGB_annotation.json',
        backend_args=None,
