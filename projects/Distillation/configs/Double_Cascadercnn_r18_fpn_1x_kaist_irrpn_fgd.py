...
__code_version__='double_cascade_rcnn_thermal_rpn'
plugin=True
...
# model settings
model = dict(
    type='MultiSpecFGDThermalFstRPNCascadeRCNN',
    ...
    teacher_cfg = './projects/BAANet/configs/teacher_cfg/BAANet_r50_fpn_1x_kaist_thermal_first.py',
    teacher_pretrained = './projects/BAANet/checkpoints/best_coco_all_iter_3000_thermal_first.pth',
    distill_cfg = [ 
...
log_level = 'INFO'
# load_from = 'D:/Senior/lab/mmdetection/work_dirs_yxx/KAIST_KAIST_double_cascade_rcnn_thermal_rpn/best_coco_all_iter_17000.pth'
resume = False
