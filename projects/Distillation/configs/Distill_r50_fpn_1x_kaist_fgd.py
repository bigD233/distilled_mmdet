...
__code_version__='distilled_with_mask_simple'
plugin=True
...
model = dict(
    ...
    teacher_cfg = './projects/BAANet/configs/BAANet_r50_fpn_1x_kaist_new.py',
    teacher_pretrained = './projects/BAANet/checkpoints/best_coco_all_iter_3500.pth',
