...
__code_version__='double_cascade_rcnn_distill_thermal_first'
plugin=True
...
# model settings
model = dict(
    type='MultiSpecFGDThermalFstCascadeRCNN',
...
log_level = 'INFO'
load_from = 'D:/Senior/lab/mmdetection/work_dirs_yxx/KAIST_double_cascade_rcnn/best_coco_all_iter_15000.pth'
resume = False
