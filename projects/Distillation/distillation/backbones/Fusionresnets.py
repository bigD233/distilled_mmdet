...
from mmengine.model import PretrainedInit, initialize, update_init_info
...
class BasicBlock(BaseModule):
    ...
    def __init__(self,
        ...
        self.conv1 = build_conv_layer(
            ...
            dilation=dilation,
            bias=False)
        self.conv1_ir = build_conv_layer(
            conv_cfg,
            inplanes,
            planes,
            3,
...
class FusionResNet(BaseModule):
    ...
    def __init__(self,
        ...
        self.fusion_block_1 = MODELS.build(fusion_block_1) if fusion_block_1 is not None else None
        self.fusion_block_2 = MODELS.build(fusion_block_2) if fusion_block_2 is not None else None
        self.fusion_block_3 = MODELS.build(fusion_block_3) if fusion_block_3 is not None else None
        self.fusion_block_4 = MODELS.build(fusion_block_4) if fusion_block_4 is not None else None

        self.fusion_module = nn.ModuleList([self.fusion_block_1,
                                           self.fusion_block_2,
                                           self.fusion_block_3,
                                           self.fusion_block_4])
        self.res_layers = []
